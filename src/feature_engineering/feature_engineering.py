...
def compute_random_forest_permutation_importance(
    ...
    *,
    ...
    result = cast(Bunch, permutation_importance(
        rf,
        X_eval_num,
        y_eval,
    ...
    importance_df = cast(pd.DataFrame, importance_df.sort_values("importance_mean", ascending=False).reset_index(drop=True))
