...
Runs the pipeline:
  ...
  2) Run Optuna optimization with K-fold cross-validation on the training split
  3) Persist best hyperparameters and cross-validated metrics to results JSON
